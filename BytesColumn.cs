...
namespace Innovoft.IO
{
	public class BytesColumn : SplitColumn<byte>, IEquatable<BytesColumn>
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out Guid value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out short value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParseObjectInt16(int offset, out object value)
		{
			if (Utf8Parser.TryParse(ToReadOnlySpan(offset), out short parsed, out var consumed))
			{
				value = parsed;
				return true;
			}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out int value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParseObjectInt32(int offset, out object value)
		{
			if (Utf8Parser.TryParse(ToReadOnlySpan(offset), out int parsed, out var consumed))
			{
				value = parsed;
				return true;
			}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out long value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out float value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParseObjectTimeSpan(int offset, out object value)
		{
			if (Utf8Parser.TryParse(ToReadOnlySpan(offset), out TimeSpan parsed, out var consumed))
			{
				value = parsed;
				return true;
			}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out ushort value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParseObjectUInt16(int offset, out object value)
		{
			if (Utf8Parser.TryParse(ToReadOnlySpan(offset), out ushort parsed, out var consumed))
			{
				value = parsed;
				return true;
			}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out uint value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParseObjectUInt32(int offset, out object value)
		{
			if (Utf8Parser.TryParse(ToReadOnlySpan(offset), out uint parsed, out var consumed))
			{
				value = parsed;
				return true;
			}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public bool TryParse(int offset, out ulong value)
		{
			return Utf8Parser.TryParse(ToReadOnlySpan(offset), out value, out var consumed);
		}
		...
		public string ToString(Decoder decoder, int starting)
		{
			var count = this.count - starting;
